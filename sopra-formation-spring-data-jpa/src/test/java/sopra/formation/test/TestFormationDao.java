...
public class TestFormationDao {
	...
	public static void main(String[] args) throws ParseException {
		...
		IMatiereRepository matiereDao = context.getBean(IMatiereRepository.class);
		ISalleRepository salleDao = context.getBean(ISalleRepository.class);
		IStagiaireRepository stagiaireDao = context.getBean(IStagiaireRepository.class);
		IUERepository ueDao = context.getBean(IUERepository.class);
