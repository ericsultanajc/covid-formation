...
import sopra.formation.persistence.sql.EvaluationDaoJpa;
import sopra.formation.persistence.sql.FiliereDaoJpa;
import sopra.formation.persistence.sql.FormateurDaoJpa;
import sopra.formation.persistence.sql.MatiereDaoJpa;
import sopra.formation.persistence.sql.SalleDaoJpa;
import sopra.formation.persistence.sql.StagiaireDaoJpa;
import sopra.formation.persistence.sql.UEDaoJpa;
